"""
Django settings for extraction_service project - Base Configuration.
...
ROOT_URLCONF = 'extraction_service.urls'
...
WSGI_APPLICATION = 'extraction_service.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for managing data extraction jobs from third-party services',
    'VERSION': '1.0.0',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'extraction_service.log',
            'formatter': 'verbose',
        },
    },
    'root': {
